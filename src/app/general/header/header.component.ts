import { Component, OnInit, HostListener, ChangeDetectorRef, ChangeDetectionStrategy, DoCheck, ViewEncapsulation, AfterViewInit, OnChanges, SimpleChanges } from '@angular/core';
...
export class HeaderComponent implements OnInit  {
  ...
  ngDoCheck() {
      ...
      if (localStorage.getItem('firstname') != null) {
        if(this.subProfile.length === 0){
          this.subProfile = JSON.parse(localStorage.getItem('subprofiles'));
          // console.error(this.subProfile, "fsdfdjjdfjd");
          this.name = localStorage.getItem('firstname');
          this.mainProfile = [JSON.parse(localStorage.getItem('main'))];
          // console.error(this.mainProfile, "ggggggg");
          // console.error('docheck true')
          this.ref.markForCheck();
