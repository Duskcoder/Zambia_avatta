...
reSize(rotation){
  ...
  videoPlayContent(videoUrl) {
    // TEST IF the Code works With other video formats
   // videoUrl='http://localhost:4200/assets/ab.mp4';
   // console.log('Video Url : ',videoUrl);
   // ENd Comment Code Works with Other video Formats
   // Code commented By: Mohamed Asif
   // alert(videoUrl);
   // alert(videoUrl.split('/'));
