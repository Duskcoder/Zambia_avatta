...
export class ChangeplanComponent implements OnInit {
  ...
  cancelSubscribe(req_id, cdata) {
    ...
    if (window.location.href.split('/')[2] == 'www.avvatta.com' || window.location.href.split('/')[2] == 'avvatta.com' || window.location.href.split('/')[2] == 'zm.avvatta.com') {
      ...
      if (window.location.href.split('/')[2] == 'zm.avvatta.com' || window.location.href.split('/')[2] == 'zm.avvatta.com') {
        let mn = JSON.parse(localStorage.getItem('log')).mobile;
        console.log(mn.toString(16));
