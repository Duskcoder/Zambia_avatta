...
paymode:any;
  ...
  ngOnInit(): void {
    ...
    this.service.getBillingEmail(id).subscribe(data =>{
      console.error(data,'billingemail')
    ...
    console.error("dasdasdasdasdsadasd",this.dialogRef)
  ...
  continuePay() { 
    ...
    console.error(datas,"asdasdas")
  this.common.paymentToken(datas).subscribe(data =>{ 
    // ngverion

    if(this.amount[0].title=="Kids Daily"){

      window.location.assign("http://zmmtn.avvatta.com/cvivamtnza/subscribe")
    }
    else if(this.amount[0].title=="Kids weekly"){
      window.location.assign("http://zmmtn.avvatta.com/cvivamtnza/subscribe/weekly")
       
    }else{
      window.location.assign("http://zmmtn.avvatta.com/cvivamtnza/subscribe/monthly")

    }

    // window.location.assign("http://zmmtn.avvatta.com/cvivamtnza/subscribe" + this.amount[0].id + '&msisdn='+this.billingMobile+'&tid=' + JSON.parse(JSON.stringify(data)).token)
    // window.location.href ="http://zmmtn.avvatta.com/cvivamtnza/subscribe" + this.amount[0].id + '&msisdn='+this.billingMobile+'&tid=' + JSON.parse(JSON.stringify(data)).token, "_self";
    // window.location.protocol = "http://zmmtn.avvatta.com/cvivamtnza/subscribe" + this.amount[0].id + '&cp=1&tid=' + JSON.parse(JSON.stringify(data)).token;
  ...
  clickContinue(val) {
    ...
    // console.log(val);
    this.amount = [val];
    console.error(this.amount,"selected")
